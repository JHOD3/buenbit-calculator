                            ...
                            <div class="pb-md-1">
                                ...
                                <div class="justify-content-center d-flex">
                                    <div class="col-md-10">
                                        ...
                                        <div class="md-form md-outline">
                                            <input class="form-control validate" id="form82" type="tel" placeholder="Teléfono" name="phone"/>
                                        </div>
...
<div class="footer-background-home align-items-center d-flex w-100 position-absolute pt-5" style="margin-top: -65px">
