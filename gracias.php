...
<body>
    ...
    <main>
        <div class="container-fluid px-0">
            <section class="section-home-mt container col-12 mx-auto px-0 mb-5">
                <div class="row col-md-11 col-12 mx-md-auto pt-5 px-0 mx-0">
                    <div class="mx-auto mb-4">
                        <h1 class="font-48 font-41-m font-weight-normal">¡Muchas gracias!</h1>
                    </div>
                    <div class="row align-items-center mx-auto col-md-12">
                        <div class="col-md-6 col-3">
                            <img class="img-gracias ml-auto mr-md-5 img-gracias d-md-block d-none" src="img/gracias-img.png"
                                 style="height: 311px;transform: scale(1.7);"/>
                            <img class="img-gracias ml-auto mr-md-5 img-gracias d-md-none d-block" src="img/gracias-img-m.png"
                                 style="height: 311px;transform: scale(1.7);"/>
                        </div>

                        <!--<div class="col-md-1 order-md-2 order-3"></div>-->
                        <div class="col-md-6 col-9">
                            <div class="font-35 font-weight-bold text-primary line-40">Solicitud <br> enviada</div>
                            <p class="line-30 mt-md-3 font-14-m">
                                Gracias por completar la solicitud. <br>Nuestro equipo realizará la evaluación
                                correspondiente <br class="d-md-block d-none"> y se pondrá en contacto a la brevedad.
                            </p>
                        </div>
                    </div>
                </div>
...
<!-- Footer-->
<div class="footer-background-home align-items-center d-flex w-100 position-absolute pt-5 ">
